// 自动生成自 db/schema.sql，勿手改；结构变更请改 db/schema.sql 后运行 bun run schema:gen
export const SCHEMA_SQL = `-- 博客核心表。posts 存文章（SSR 时渲染 content_html），tags/post_tags 多对多，pages 存静态页。
